package com.muyi.utilsfactory.TextUtils;
...
public class JustifyTextView extends TextView {
    ...
    private void drawScaleText(Canvas canvas, int lineStart, String line, float lineWidth){
